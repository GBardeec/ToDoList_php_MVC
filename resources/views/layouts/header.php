        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid pl-0">
                ...
                <?php if (isset($_SESSION['login'])): ?>
                    <a type="button" class="btn btn-secondary" href="<?= addDomainToUrl('/php_to_do_list/controller/auth/logout.php') ?>">
                        Выйти
                    </a>
                <?php else: ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" name="loginform" action="<?= addDomainToUrl('/php_to_do_list/controller/auth/auth.php') ?>">
                            <div class="row mb-3">
